  ...
  render () {
    return <div>
      ...
      <div className="docContent">
        <div className="row">
          <div className="eight columns">
            <em>Note: This is an unofficial mirror of the docs. For the real thing, please see the <a href="https://plot.ly/javascript/reference/">plotly.js figure reference</a>.</em>
          </div>
        </div>
