  ...
  render () {
    ...
    return <div>
      ...
      <div className="docContent">
        <div className="row">
          <div className="eight columns">
            <em>Note: This is an unofficial mirror of the plotly.js figure reference. It's an experiment at making the docs hierarchical and searchable. For the real thing, please see the <a href="https://plot.ly/javascript/reference/" target="_blank">plotly.js figure reference</a>.</em>
          </div>
        </div>
